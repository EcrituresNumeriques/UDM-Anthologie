...
class UridCategoriesType extends AbstractType
{
    ...
    public function buildForm (FormBuilderInterface $builder , array $options)
    {
        ...
        $this->arrayFieldTransformer = [
            ...
            "uridCategoryTranslations" => UridCategoriesTranslationsType::class ,
        ];

        $builder
            ->add('uridCategoryTranslations' , EntityType::class , array(
                'class'    => 'AppBundle\Entity\ScholiesTranslations' ,
                'required' => false ,
                'multiple' => true
            ))
            ->add('group')
